...
public class LikeablePersonServiceTests {
    ...
    void t001() throws Exception {
        ...
        */
        ...
        // 인스타 아이디가 insta_user3 인 사람이 호감을 표시한 `좋아요` 목록
        // 좋아요는 2가지로 구성되어 있다 : from(호감표시자), to(호감받은 자)
        /*
        SELECT *
        FROM likeable_person
        ...
        */
        ...
        for (LikeablePerson likeablePerson : fromLikeablePeople) {
            // 당연하게 그 특정회원(인스타아이디 insta_user3)이 좋아요의 호감표시자 회원과 같은 사람이다.
